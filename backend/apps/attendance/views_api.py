...
class MemberQRCodeViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class AttendanceSessionViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class CheckInViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
...
class AbsenceAlertViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class ChildCheckInViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class NFCTagViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    """CRUD for NFC tags."""
...
class GeoFenceViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    """CRUD for geo-fences."""
...
class VisitorInfoViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class CheckOutViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
...
class FamilyCheckInViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
...
class AttendanceAnalyticsViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
