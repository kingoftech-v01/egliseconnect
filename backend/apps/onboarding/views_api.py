...
from apps.core.throttles import RateLimitHeadersMixin
from .models import (
...
class TrainingCourseViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    queryset = TrainingCourse.objects.filter(is_active=True)
    serializer_class = TrainingCourseSerializer
    permission_classes = [IsAuthenticated, IsPastorOrAdmin]


class LessonViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class MemberTrainingViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class InterviewViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class OnboardingStatusView(RateLimitHeadersMixin, viewsets.ViewSet):
...
class OnboardingStatsView(RateLimitHeadersMixin, viewsets.ViewSet):
...
class MentorAssignmentViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class OnboardingFormFieldViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class OnboardingFormResponseViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class WelcomeSequenceViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class WelcomeProgressViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class OnboardingDocumentViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class DocumentSignatureViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class VisitorFollowUpViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class OnboardingTrackViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class AchievementViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class MemberAchievementViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class QuizViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class QuizAttemptViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
