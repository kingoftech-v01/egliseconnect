...
class DonationViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class DonationCampaignViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    ...
    def active(self, request):
        ...
        if page is not None:
            serializer = DonationCampaignListSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)
        serializer = DonationCampaignListSerializer(campaigns, many=True)
        return Response(serializer.data)


class TaxReceiptViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    ...
    def my_receipts(self, request):
        ...
        if page is not None:
            serializer = TaxReceiptListSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)
...
class PledgeViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class GivingStatementViewSet(RateLimitHeadersMixin, viewsets.ReadOnlyModelViewSet):
...
class GivingGoalViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class DonationImportViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    ...
    def rows(self, request, pk=None):
        ...
        if page is not None:
            serializer = DonationImportRowSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)
        serializer = DonationImportRowSerializer(rows, many=True)
        return Response(serializer.data)


class MatchingCampaignViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class CryptoDonationViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class AnalyticsViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
