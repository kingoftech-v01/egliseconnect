...
class DashboardViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
...
class ReportViewSet(RateLimitHeadersMixin, viewsets.ViewSet):
    permission_classes = [IsAuthenticated, IsPastor | IsAdmin]
...
class ReportScheduleViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class SavedReportViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
