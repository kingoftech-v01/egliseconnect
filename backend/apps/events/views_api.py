...
class EventViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    ...
    def attendees(self, request, pk=None):
        ...
        if page is not None:
            serializer = EventRSVPSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)
        serializer = EventRSVPSerializer(rsvps, many=True)
        return Response(serializer.data)


class RoomViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    """CRUD for rooms."""
...
class RoomBookingViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class EventTemplateViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class EventVolunteerNeedViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class EventPhotoViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class EventSurveyViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
    """CRUD for surveys."""
