...
class NewsletterViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class NotificationViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class NotificationPreferenceViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class SMSMessageViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class SMSTemplateViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class SMSOptOutViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class PushSubscriptionViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class EmailTemplateViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class AutomationViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class AutomationStepViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class AutomationEnrollmentViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class ABTestViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class DirectMessageViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class GroupChatViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
...
class GroupChatMessageViewSet(RateLimitHeadersMixin, viewsets.ModelViewSet):
